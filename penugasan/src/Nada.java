public class Nada extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double nilaiUAS=Double.valueOf(jTextField4.getText());
    ...
    if ((nilaiakhir>=80.1)&&(nilaiakhhir<=100)){
        ...
        jTextField7.setText("Tidak Lulus");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
